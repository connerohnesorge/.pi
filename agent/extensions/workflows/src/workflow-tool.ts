...
const workflowToolSchema = Type.Object({
  ...
  tokenBudget: Type.Optional(
    Type.Number({
      description:
        "Hard total-token budget for the whole run. Once spent reaches it, further agent() calls fail and the run stops. Defaults to 272,000 tokens; set this to override the default cap.",
    }),
  ),
});
